import { Text, Box, Heading, Image, HStack, IconButton, useColorModeValue, useToast, VStack, Input, Button } from "@chakra-ui/react"
...
const ProductCard = ({product}) => {
   ...
   const handleUpdateProduct = async (pid, updatedProduct)=>{
       ...
       if(!success){
        ...
        toast({
          title:'Success', description: 'Product updated successfully', status: 'success',  duration: 3000, isClosable: true,
        })
       }
   }
